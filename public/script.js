...
let selected_id , selected_name , selected_lastName ,selected_email;
let row_2_data_6;
...
function checkUserNameUpdate(){
    if(inputName2.value.match(regForName) && inputName2.value !== ""){
        update_user_text.innerHTML = "Valid Name"
        update_user_text.style.color = "green";
        returnName = true;
        selected_name = inputName2.value;
        return true
    }else{
        update_user_text.innerHTML = "Invalid Name"
...
function checkUserID(){
    ...
    if(enteredId == 0){
        add_user_text.innerHTML = "ID should be grater than 0"
...
function checkUserName(){
    if(inputName.value.match(regForName) && inputName.value !== ""){
        add_user_text.innerHTML = "Valid Name"
        add_user_text.style.color = "green";
        returnName = true;
        selected_name = inputName.value;
        return true
    }else{
        add_user_text.innerHTML = "Invalid Name"
        add_user_text.style.color = "red";
        return false
    }
}
...
async function postUser(post){
    ...
    add_user_text.innerHTML = "User added successfully. You can add more users and then click on button to see all added users"
    add_user_text.style.color = "green"; 
    }else if(response.success == false){
        add_user_text.innerHTML = "The ID is already used, please select other ID"
        add_user_text.style.color = "red"; 
    }
}
